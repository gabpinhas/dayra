      ...
      <AnimatePresence>
        {showLetter && (
          <motion.div
            ...
            className="w-64 mt-6 p-8 bg-gray-100 rounded-xl shadow-lg text-gray-800 md:w-full"
          >
            <p className="font-semibold font-sans text-cyan-900 text-base md:text-lg">
